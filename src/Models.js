...
export default class Models {
  ...
  constructor(scene, loader, window) {
    ...
    let mario_material = new THREE.MeshBasicMaterial({
      map: mario_texture,
    ...
    let osu_material = new THREE.MeshBasicMaterial({
      map: osu_texture,
      side: THREE.FrontSide,
      toneMapped: false,
    });
    ...
    let formula_material = new THREE.MeshBasicMaterial({
      map: formula_texture,
    ...
    let vintage_material = new THREE.MeshBasicMaterial({
      map: vintage_texture,
      side: THREE.FrontSide,
      toneMapped: false,
    });
    ...
    let helmet_material = new THREE.MeshBasicMaterial({
      map: helmet_texture,
      side: THREE.FrontSide,
      toneMapped: false,
    });
    ...
    let screen_geometry = new THREE.BoxGeometry(0.7, 0.39, 0.0001);
